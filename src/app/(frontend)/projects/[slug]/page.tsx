...
export default async function ProjectDetailPage({ params: paramsPromise }: Args) {
    ...
    const imageUrl = typeof project.image === 'object' && project.image?.url ? project.image.url : null
                        ...
                        <div className="mt-16">
                            ...
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                {project.gallery.map((item, i) => {
                                    const galleryImageUrl = typeof item.image === 'object' && item.image?.url ? item.image.url : null
